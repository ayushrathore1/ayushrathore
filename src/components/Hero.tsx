  ...
  return (
    <section 
      ...
      className={cn(
        ...
        "bg-forest bg-cover bg-center bg-no-repeat parallax"
      )}
    >
      ...
      <div className="container mx-auto z-10 px-6 sm:px-8 md:px-12 lg:px-24 animate-fade-in">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-block mb-6 p-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20">
            <div className="text-sm font-medium text-white px-4 py-1">
              Nature-inspired Portfolio
            </div>
          </div>
      ...
      <div className="absolute bottom-10 left-0 right-0 flex justify-center">
        <a 
          href="#about"
          className="flex items-center justify-center w-10 h-10 rounded-full bg-white/10 backdrop-blur-lg animate-bounce"
