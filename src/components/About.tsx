        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div data-aos="fade-left" className="space-y-6">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 tracking-tight">
              A Developer with a{" "}
              <span className="text-nature-medium-green dark:text-nature-light-green">
                Creator's Heart
              </span>
            </h2>
            ...
            <div className="space-y-4 text-lg">
              <p className="text-muted-foreground">
                I'm Ayush Rathore, a developer focused on creating beautiful,
                functional experiences. My journey in technology is driven by
                curiosity and a desire to build solutions that matter.
              </p>

              <p className="text-muted-foreground">
                With a background in design and a deep appreciation for nature,
              ...
              <div className="pt-4">
                ...
                <p className="text-muted-foreground italic">
                  "Collaboration over competition. The best results come from
                  shared knowledge and collective creativity."
                </p>
              </div>
            </div>
