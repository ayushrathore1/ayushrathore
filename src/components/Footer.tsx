        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
            ...
            <div className="flex gap-4">
              {socialLinks.map(social => <a key={social.name} href={social.url} target="_blank" rel="noopener noreferrer" className={cn("p-3 rounded-full", "bg-gray-100 hover:bg-primary-foreground/20", "transition-colors duration-300")} aria-label={`Follow on ${social.name}`}>
